<?php 
    ...
    if(isset($_POST['login-btn'])){
        ...
        $sql = "SELECT * FROM users_timviec WHERE username='".$_POST['username']."' AND password='".$_POST['password']."'";
        ...
        <section style="padding-top:30px;">
            <div class="container">
                <div class="section-heading">
                    <h1 class="text-center title wow fadeInDown"><span aria-hidden="true"></span>Đăng nhập tài khoản tìm việc</h1> 
                </div>
                <div class="row"> 
                    <form name="login" action="login.php" method="POST" onsubmit="return validate();">
                        <div class="col-md-4 col-md-offset-4">
                            <div class="login-form"> 
                                ...
                                <div class="form-group">
                                    <input class="btn btn-info" type='submit' name="login-btn" value='Đăng nhập' />
                                </div> 
