...
<?php 
    ...
    $sql = "SELECT * FROM users_profile INNER JOIN users_timviec ON users_profile.users_id = users_timviec.id  WHERE users_profile.users_id = $id";
    ...
    if (isset($_POST['btn_submit_pro'])) {
        ...
        $sql = "UPDATE users_profile SET    fullname = '".$_POST['fullname']."', 
                                            phone = '".$_POST['phone']."',
                                            marital_status = '".$_POST['marital_status']."', 
                                            city = '".$_POST['city']."',
                                            address = '".$_POST['address']."', 
                                            ...
                                            email_pro = '".$_POST['email_pro']."' WHERE users_profile.users_id = $id";

        if (mysqli_multi_query($link, $sql)){
            while ( $data = mysqli_fetch_array($query) ) {
            echo '<script language="javascript">alert("Update thành công "); window.location="viewprofile.php?id='.$data['users_id'].'";</script>';
            }
        }
        else {
            echo '<script language="javascript">alert("Có lỗi trong quá trình xử lý"); window.location="viewprofile.php?id='.$data['users_profile.users_id'].'";</script>';
        }
    }
?>
                    ...
                    <div class="col-md-8">
                        <form class="form-horizontal" method="post">
                           ...
                           <header class="block-title" id="block-title-seeker-info">
                            ...
                            <input type="text" class="form-control hidden" id="users_id" name="users_id" value="<?= $data['user_id'] ?>">
                            <div class="form-group">
                                <label class="control-label col-md-3">Họ tên</label>
                                <div class="col-md-9">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3">Email</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="email_pro" value="<?= $data['email_pro'] ?>">
                                </div>
                            </div>
                            <div class="form-group" name="">
                                ...
                                <div class="col-md-3">
                                    <select class="form-control" name="birth_day" >
                                        ...
                                        <?php for ($i = 1; $i <= 31; $i++) : ?> 
                                            <option value="<?php if($i < 10) echo "0$i"; if($i >= 10) echo $i; ?>" <?php if(substr($data['birthday'], 8, 2) == $i){ echo " selected='selected'";} ?>><?php if($i < 10) echo "0$i"; if($i >= 10) echo $i; ?></option>
                                        <?php endfor; ?>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <select class="form-control" name="birth_month">
                                        ...
                                        <?php for ($i = 1; $i <= 12; $i++) : ?> 
                                            <option value="<?php echo $i; ?>" <?php if(substr($data['birthday'], 5, 2) == $i){ echo " selected='selected'";} ?>><?php echo $i; ?></option>
                                        <?php endfor; ?>
                                    </select>
                                </div>                             
                                <div class="col-md-3">
                                    <select class="form-control" name="birth_year">
                                        ...
                                        <?php for ($i = $now['year']; $i > 1950; $i--) : ?> 
                                            <option value="<?php echo $i; ?>" <?php if(substr($data['birthday'], 0, 4) == $i){ echo " selected='selected'";} ?>><?php echo $i; ?></option>
                                        <?php endfor; ?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control" name="marital_status" >
                                        ...
                                        <option value="1" <?php if($data['marital_status'] == "1"){ echo " selected='selected'"; } ?>>Độc thân</option>
                                        <option value="2" <?php if($data['marital_status'] == "2"){ echo " selected='selected'"; } ?>>Đã có gia đình</option>
                                </select>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control" name="education" value="">
                                        ...
                                        <option value="7" <?php if($data['education'] == "7"){ echo " selected='selected'"; } ?>>Cao học</option>
                                        <option value="6" <?php if($data['education'] == "6"){ echo " selected='selected'"; } ?>>Đại học</option>
                                        <option value="5" <?php if($data['education'] == "5"){ echo " selected='selected'"; } ?>>Cao đẳng</option>
                                        <option value="4" <?php if($data['education'] == "4"){ echo " selected='selected'"; } ?>>Trung cấp</option>
                                        <option value="3" <?php if($data['education'] == "3"){ echo " selected='selected'"; } ?>>Trung học</option>
                                        <option value="2" <?php if($data['education'] == "2"){ echo " selected='selected'"; } ?>>Chứng chỉ</option>
                                        <option value="1" <?php if($data['education'] == "1"){ echo " selected='selected'"; } ?>>Lao động phổ thông</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control" name="exp" value="<?= $data[''] ?>">
                                        ...
                                        <option value="8" <?php if($data['exp'] == "7"){ echo " selected='selected'"; } ?>>Trên 5 năm</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control" name="level_rank" value="<?= $data[''] ?>">
                                        <option value="">Chọn cấp bậc</option>
                                        <option value="1" <?php if($data['level_rank'] == "1"){ echo " selected='selected'"; } ?>>Nhân viên</option>
                                        <option value="2" <?php if($data['level_rank'] == "2"){ echo " selected='selected'"; } ?>>CTV</option>
                                        <option value="3" <?php if($data['level_rank'] == "3"){ echo " selected='selected'"; } ?>>Trưởng nhóm</option>
                                        <option value="4" <?php if($data['level_rank'] == "4"){ echo " selected='selected'"; } ?>>Chuyên gia</option>
                                        <option value="5" <?php if($data['level_rank'] == "5"){ echo " selected='selected'"; } ?>>Trưởng phó phòng</option>
                                        <option value="6" <?php if($data['level_rank'] == "6"){ echo " selected='selected'"; } ?>>Quản lý cấp cao</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control" name="level_desired" value="">
                                        <option value="">Chọn cấp bậc</option>
                                        <option value="1" <?php if($data['level_desired'] == "1"){ echo " selected='selected'"; } ?>>Nhân viên</option>
                                        <option value="2" <?php if($data['level_desired'] == "2"){ echo " selected='selected'"; } ?>>CTV</option>
                                        <option value="3" <?php if($data['level_desired'] == "3"){ echo " selected='selected'"; } ?>>Trưởng nhóm</option>
                                        <option value="4" <?php if($data['level_desired'] == "4"){ echo " selected='selected'"; } ?>>Chuyên gia</option>
                                        <option value="5" <?php if($data['level_desired'] == "5"){ echo " selected='selected'"; } ?>>Trưởng phó phòng</option>
                                        <option value="6" <?php if($data['level_desired'] == "6"){ echo " selected='selected'"; } ?>>Quản lý cấp cao</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text"  class="form-control" name="career" value="<?= $data['career'] ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="wage_desired" value="<?= $data['wage_desired'] ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3">Nơi làm việc mong muốn</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="add_desired" value="<?= $data['add_desired'] ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-offset-2 col-md-10">    
                                    <input type="submit" class="btn btn-info col-md-offset-1" name="btn_submit_pro" id="btn_submit_pro" value="Update">
                                </div>
                            </div>
                            <?php } ?>
                        </form>
